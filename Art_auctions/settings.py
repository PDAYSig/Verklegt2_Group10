"""
Django settings for Art_auctions project.
...
SECRET_KEY = 'django-insecure-&(k93j$9a_%&p_$wkc%_#f4^wv$s%46_sxi52)2q$wzon-m^%f'
...
ROOT_URLCONF = 'Art_auctions.urls'
...
WSGI_APPLICATION = 'Art_auctions.wsgi.application'
